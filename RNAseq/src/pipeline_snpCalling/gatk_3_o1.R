...
for (i in bam_files){
  ...
  system(paste(bsub_fig,outDir,sample_id,'.out java -jar ',gatk_loc,' -T RealignerTargetCreator -R ',ref_fasta,' -I ',bamDir,i,' -o ',outDir,sample_id,'.intervals -known ',known_vcf,sep = ''))
}