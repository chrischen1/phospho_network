...
write.csv(unique(interaction_table_site3[,1:5]),paste(interactions_path,output_file_site,sep = '/'),row.names = F)
write.csv(unique(interaction_table_gene2[,1:2]),paste(interactions_path,output_file_gene,sep = '/'),row.names = F)
write.csv(source_table,paste(interactions_path,'source_table.csv',sep = '/'),row.names = F)
