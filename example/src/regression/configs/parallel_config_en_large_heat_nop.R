# Set parameters
result_path       = '~/Documents/workspace/phospho_network/example/script_files/output/enL_heat_nop_results'
algos             = 'en'  # en for elastic net, rf for random forest
alphas            = seq(0,1,0.05) #required for elastic net
i_penalty         = F     # required for elastic net use different penalty based on heat diffusion?
