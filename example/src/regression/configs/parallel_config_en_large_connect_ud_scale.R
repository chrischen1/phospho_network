# Set parameters
result_path       = '~/Documents/workspace/phospho_network/example/script_files/output/enL_connect_ud_scale_results'
...
outerfold         = 10
innerfold         = 5
scale_method      = "scale"   # 0-1 or "scale" 
directional       = F       # Used except pred_choose is flat. Should only upstream nodes in the pathway be considered?
pred_choose       = 'connect'    # method of choose different predictor : hf: by heat diffusion,connect:all connected nodes, direct: direct nodes, flat: all nodes in network
