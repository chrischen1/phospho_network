# Set parameters
result_path       = '~/Documents/workspace/phospho_network/example/script_files/output/random/enL_random_results_k8100'
...
pred_choose       = 'random'   # method of choose different predictor : hf: by heat diffusion,connect:all connected nodes, direct: direct nodes, flat: all nodes in network
k                 = 8100   # used if pred_choose is hf, a parameter to define the extend of predictors by keep nodes receive more heat than k*(heat_response_CNV)
...
# target value input:
mdata_filename        = '~/Documents/workspace/phospho_network/script_files/analysis_rppa/rppa_rand.csv'
